...
import { createProductController, deleteProductController, listProductUniqueController, listProductsController, updateProductController, uploadProductController } from "../controllers/products.controllers";
